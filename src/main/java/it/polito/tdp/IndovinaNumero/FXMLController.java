...
import it.polito.tdp.IndovinaNumero.model.Gioco.StatoGioco;
...
//    	this.txtRisultato.setText(Integer.toString(numeroSegreto));
    ...
    void doProva(ActionEvent event) {
    	...
    	StatoGioco risultato = model.faiTentativo(guess);
